...
namespace Fizz
{
    class Fmeniu
    {
        ...
        public static void Loadmenu()
        {
            ...
            MenuHarass.Add("harassMode", new ComboBox("Harass Mode: ", 0, new string[] { "Agressive Mode", "Safe Mode" }));
            ...
            MenuMisc.Add("skinhack", SkinEnable);
            MenuMisc.Add("skinid", SkinSlider);
            MenuMisc.Add("Use.Ignite", new CheckBox("Use Ignite"));
            MenuMisc.Add("UseAutoEOnTurrets", new CheckBox("Use Auto E On Turrets"));
            MenuMisc.Add("UseZhonyas", new Slider("Use Zhonyas on hp lower than {0} % ", 30, 0, 100));
        ...
        {
            get { return MenuHarass["harassMode"].Cast<ComboBox>().SelectedText; }
        }
        ...
        {
            get { return MenuMisc["skinid"].Cast<Slider>().CurrentValue; }
        }
        public static int Use_hourglass
        {
            get { return MenuMisc["UseZhonyas"].Cast<Slider>().CurrentValue; }
        }
        public static bool enableSkinHack
        {
            get { return MenuMisc["skinhack"].Cast<CheckBox>().CurrentValue; }
        }
